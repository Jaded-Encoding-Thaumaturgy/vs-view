...
from vsview.api import Checkbox, Dropdown, PluginAPI, PluginBase, PluginGraphicsView, Spin, hookimpl
...
class FFTSpectrumPlugin(PluginBase):
    ...
    def __init__(self, parent: QWidget, api: PluginAPI) -> None:
        ...
        self.view = FFTSpectrumView(self, self.api, self.global_settings)
    ...
    def on_settings_changed(self) -> None:
        self.view.set_autofit(self.global_settings.autofit)
        self.view.global_settings = self.global_settings
        self.view.refresh(self)


class FFTSpectrumView(PluginGraphicsView):
    def __init__(self, parent: QWidget, api: PluginAPI, global_settings: GlobalSettings) -> None:
        super().__init__(parent, api)
        self.global_settings = global_settings
        self.autofit = self.global_settings.autofit
    ...
    def get_node(self, clip: VideoNode) -> VideoNode:
        ...
        def fft(p: VideoNode, text: str) -> VideoNode:
            ...
            if self.global_settings.write_plane_name:
                p = p.text.Text(text, self.global_settings.alignment, self.global_settings.scale)
        ...
        stacked = stack_planes(clip_fft, False, False, self.global_settings.mode)
